...
const translates = {
  ...
  yj_wanglang_prefix: "☆",
  fuyu: "负隅",
  fuyu_info: "每回合每项各限一次，当你成为其他角色使用基本牌或普通锦囊牌的唯一目标后，或你使用基本牌或普通锦囊牌指定其他角色为唯一目标后，你可与其拼点：若此牌的使用者赢，此牌额外结算一次；若此牌的使用者没赢，此牌无效。若你的拼点结果与上一次发动此技能时相同，你摸两张牌。",
  zhanshi: "瞻势",
  ...
  dcfujue: "复爵",
  dcfujue_info: "出牌阶段限一次。你可以将你的手牌调整至五张，然后移动场上一张牌。若你于此流程中获得且失去过牌，本回合你计算与其他角色的距离-1且你下次使用的牌不可被响应。",
  xjzhitu: "制图",
